...
export default function TaskPage() {
    ...
    const [currentSection, setCurrentSection] = useState<keyof typeof tasks>("todo");
    ...
    return (
        <Container>
            ...
            <Typography fontWeight="bold" variant="h3" component="h2" sx={{ padding: 2, mt: 5, mb: 2 }}>
                Task Page
            </Typography>
            ...
            <Dialog open={dialogOpen} onClose={handleCloseDialog}>
                ...
                <DialogContent>
                    ...
                    <TextField
                        ...
                        onChange={(e) => setNewTask((prev) => ({ ...prev, secondary: e.target.value }))}
                    />
                </DialogContent>
                <DialogActions>
...
function TaskSection({ title, tasks, onAddTask, onDeleteTask }: TaskSectionProps) {
    return (
        <Box
            sx={{
                flexGrow: 1,
        ...
        >
            <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <Box>
                    ...
                    <IconButton aria-label="delete" color="default" onClick={onDeleteTask}>
            ...
            <List>
                {tasks.map((task, index) => (
                    <ListItem
                        key={index}
                        disablePadding
                        sx={{ backgroundColor: "white", borderRadius: "8px", marginBottom: "8px" }}
                    >
                        <ListItemButton>
                            <ListItemText
